    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            if (!_.isUndefined(body.productProjection)) {
                drupalService.deleteDRLEntity(process.env.DRUPAL_PRODUCT_SERVICE_URL, body.productProjection)
...
module.exports = {
    migrate: (body, callback) => migrateDeleted(body, callback)
}